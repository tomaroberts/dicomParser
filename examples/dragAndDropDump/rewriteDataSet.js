...
function rewriteDataSet(dataSet, output) {
    ...
    try {
        for (var propertyName in dataSet.elements) {
            ...
            // TAR: big if clause. Checks:
            // if SQ item (nested tags)
            // if fragment (not sure what these are...)
            // otherwise everything else (basically first-level tags)
